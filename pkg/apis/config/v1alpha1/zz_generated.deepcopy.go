...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BucketBackend) DeepCopyInto(out *BucketBackend) {
	*out = *in
	out.Elasticsearch = in.Elasticsearch
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BucketBackend.
func (in *BucketBackend) DeepCopy() *BucketBackend {
	if in == nil {
		return nil
	}
	out := new(BucketBackend)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BucketBackendElasticsearch) DeepCopyInto(out *BucketBackendElasticsearch) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BucketBackendElasticsearch.
func (in *BucketBackendElasticsearch) DeepCopy() *BucketBackendElasticsearch {
	if in == nil {
		return nil
	}
	out := new(BucketBackendElasticsearch)
	in.DeepCopyInto(out)
	return out
}
